...
import AprendiendoMatematicas.Informacion;
public class AyudaSuma extends javax.swing.JDialog {
    public AyudaSuma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
